...
public final class DictionaryEnglish extends Dictionary{
	...
	DictionaryEnglish(ELanguage language){
		...
		aboutText.append( "on a hosting platform called <a href=\"https://www.digitalocean.com/\">Digital Ocean</a>.<br>For the layout of the website " );
		aboutText.append( "<a href=\"http://getbootstrap.com/\"><i class=\"fab fa-bootstrap\"></i> Bootstrap</a> and ");
		aboutText.append( "<a href=\"https://fontawesome.com/\"><i class=\"fab fa-fort-awesome-alt\"></i> Font Awesome</a> are used. <br><br> ");
